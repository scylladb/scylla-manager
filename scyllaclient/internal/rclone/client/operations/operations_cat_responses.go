...
func (o *OperationsCatOK) Error() string {
	return fmt.Sprintf("[POST /operations/cat][%d] operationsCatOK  %+v", 200, o.Payload)
}
...
func (o *OperationsCatNotFound) Error() string {
	return fmt.Sprintf("[POST /operations/cat][%d] operationsCatNotFound  %+v", 404, o.Payload)
}
...
func (o *OperationsCatInternalServerError) Error() string {
	return fmt.Sprintf("[POST /operations/cat][%d] operationsCatInternalServerError  %+v", 500, o.Payload)
}
