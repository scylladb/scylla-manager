...
All parameters can be found in the [sctool backup](https://manager.docs.scylladb.com/stable/sctool/backup.md#sctool-backup) command reference.
...
* `-c` - the [name](https://manager.docs.scylladb.com/stable/sctool/cluster.md#cluster-add) you used when you created the cluster
...
This ID can be used to query the status of the backup task, to defer the task to another time, or to cancel the task See [Managing Tasks](https://manager.docs.scylladb.com/stable/sctool/task.md#task-commands).
...
Additional parameters can be used. Refer to [backup parameters](https://manager.docs.scylladb.com/stable/sctool/backup.md#sctool-backup).
...
Progress of the backup task can be monitored by using [sctool progress](https://manager.docs.scylladb.com/stable/sctool/progress.md#task-progress) command and providing UUID of the backup task.
