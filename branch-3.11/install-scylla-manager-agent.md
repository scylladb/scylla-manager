...
2. Add the ScyllaDB Manager APT repository to your system.
   > ```console
   > sudo curl -o /etc/apt/sources.list.d/scylla-manager.list -L https://downloads.scylladb.com/deb/debian/scylladb-manager-3.11.list
   > ```
...
>    > ```console
>    > sudo curl -o /etc/yum.repos.d/scylla-manager.repo -L https://downloads.scylladb.com/rpm/centos/scylladb-manager-3.11.repo
>    > ```
...
* [Configure backup location](https://manager.docs.scylladb.com/branch-3.11/backup/index.md#backup-location)
* [Configure native backup](https://manager.docs.scylladb.com/branch-3.11/backup/native-backup.md#configure-native-backup-in-scylla)
* [Add a Cluster](https://manager.docs.scylladb.com/branch-3.11/add-a-cluster.md)
