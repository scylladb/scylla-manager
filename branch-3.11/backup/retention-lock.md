...
Retention lock is currently supported for [Google Cloud Storage](https://manager.docs.scylladb.com/branch-3.11/backup/setup-gcs.md) only.
...
Retention lock supports three modes controlled by the [sctool backup –retention-lock-mode](https://manager.docs.scylladb.com/branch-3.11/sctool/backup.md#sctool-backup) flag:
...
The [sctool backup –override-retention-lock](https://manager.docs.scylladb.com/branch-3.11/sctool/backup.md#sctool-backup) flag allows overriding previously
...
as described in [Setup Google Cloud Storage](https://manager.docs.scylladb.com/branch-3.11/backup/setup-gcs.md).

## Usage

### Creating retention lock configuration

You can [create a new backup task](https://manager.docs.scylladb.com/branch-3.11/sctool/backup.md#sctool-backup) with retention lock enabled:

```none
sctool backup -c <cluster ID> -L gcs:<bucket> --retention-lock-mode locked --retention-days 30
```

You can also [update an existing backup task](https://manager.docs.scylladb.com/branch-3.11/sctool/backup.md#backup-update) to enable retention lock:
