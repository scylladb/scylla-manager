...
> * [Schedule a repair](#schedule-a-repair)
> * [Create an ad-hoc repair](#create-an-ad-hoc-repair)
> * [Perform a dry run of a repair](#perform-a-dry-run-of-a-repair)
> * [Monitor progress of the repair task](#monitor-progress-of-the-repair-task)

This document contains examples for scheduling and running repairs.

<a id="schedule-a-repair"></a>
...
Additional parameters are described in the [sctool repair](https://manager.docs.scylladb.com/branch-3.11/sctool/repair.md#repair-commands) command reference.
...
This ID can be used to query the status of the repair task, to defer the task to another time, or to cancel the task See [Managing Tasks](https://manager.docs.scylladb.com/branch-3.11/sctool/task.md#task-commands).
...
Additional parameters can be used. Refer to [repair parameters](https://manager.docs.scylladb.com/branch-3.11/sctool/repair.md#sctool-repair).
...
Progress of the repair task can be monitored by using the [sctool progress](https://manager.docs.scylladb.com/branch-3.11/sctool/progress.md#task-progress) command and providing UUID of the repair task.
...
> * displayed parallel and intensity account for changes introduce with [sctool repair control](https://manager.docs.scylladb.com/branch-3.11/sctool/repair.md#repair-control)
