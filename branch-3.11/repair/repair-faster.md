...
You can view your current values for intensity and parallel with the [sctool progress](https://manager.docs.scylladb.com/branch-3.11/sctool/progress.md#task-progress) command.
Stopping the task and running it again would reset the values.

## Speedup the future runs of a repair

If you wish to change intensity or parallelism of a repair task that is scheduled, but not running use [sctool repair update](https://manager.docs.scylladb.com/branch-3.11/sctool/repair.md#repair-update) command.
