...
If you wish to change intensity and parallelism level of a repair task use [sctool repair update](https://manager.docs.scylladb.com/stable/sctool/repair.md#repair-update) command.
Run the following command to limit the number of parallel ScyllaDB repair jobs in the cluster to one.
