...
The [sctool restore](https://manager.docs.scylladb.com/stable/sctool/restore.md#sctool-restore) command allows you to run a restore of backed-up data (identified by its snapshot-tag) into a cluster.
...
> * [restore tables](https://manager.docs.scylladb.com/stable/restore/restore-tables.md) - restores the content of the tables (rows)
>   * [1-1 restore](https://manager.docs.scylladb.com/stable/restore/restore-tables.md#restore) - faster restore of tables, please check the limitations before using it
> * [restore schema](https://manager.docs.scylladb.com/stable/restore/restore-schema.md) - restores the ScyllaDB cluster schema
...
* [Dry run](https://manager.docs.scylladb.com/stable/restore/examples.md#restore-dry-run) - Test restore before live execution
* Progress tracking ([sctool progress](https://manager.docs.scylladb.com/stable/sctool/progress.md#task-progress), Prometheus metrics, [ScyllaDB Monitoring](https://monitoring.docs.scylladb.com) Manager dashboard)
* [Pausing](https://manager.docs.scylladb.com/stable/sctool/stop.md#task-stop) and [resuming](https://manager.docs.scylladb.com/stable/sctool/start.md#task-start) at any point of the process

## Restore speed observability

Restore speed can be checked with [sctool progress](https://manager.docs.scylladb.com/stable/sctool/progress.md#task-progress) command.
<br/>
...
Restore speed is controlled by many parameters (see [sctool restore](https://manager.docs.scylladb.com/stable/sctool/restore.md#sctool-restore) documentation for details):
...
bandwidth, you could try to [pause](https://manager.docs.scylladb.com/stable/sctool/stop.md#task-stop) restore task, [update](https://manager.docs.scylladb.com/stable/sctool/restore.md#restore-update) it with `--unpin-agent-cpu`,
and [resume](https://manager.docs.scylladb.com/stable/sctool/start.md#task-start) it.
