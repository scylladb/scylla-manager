...
Additional parameters are described in the [sctool repair](https://manager.docs.scylladb.com/branch-3.10/sctool/repair.md#repair-commands) command reference.
...
This ID can be used to query the status of the repair task, to defer the task to another time, or to cancel the task See [Managing Tasks](https://manager.docs.scylladb.com/branch-3.10/sctool/task.md#task-commands).
...
Additional parameters can be used. Refer to [repair parameters](https://manager.docs.scylladb.com/branch-3.10/sctool/repair.md#sctool-repair).
...
Progress of the repair task can be monitored by using the [sctool progress](https://manager.docs.scylladb.com/branch-3.10/sctool/progress.md#task-progress) command and providing UUID of the repair task.
...
> * displayed parallel and intensity account for changes introduce with [sctool repair control](https://manager.docs.scylladb.com/branch-3.10/sctool/repair.md#repair-control)
