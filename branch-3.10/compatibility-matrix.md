...
#### WARNING
Restoring schema into a cluster with ScyllaDB **5.4.X** or **2024.1.X** with `consistent_cluster_management: true` isn’t supported. Please see the following [workaround](https://manager.docs.scylladb.com/branch-3.10/restore/old-restore-schema.md#restore-schema-workaround).

|   ScyllaDB Manager Version | ScyllaDB Version                           |
|----------------------------|--------------------------------------------|
|                        3.1 | 2025.1, 2025.4, 2026.1                     |
