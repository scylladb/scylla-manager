...
Native restore is an optimization similar to [native backup](https://manager.docs.scylladb.com/branch-3.10/backup/native-backup.md).
...
Just like with native backup, both native and rclone restores performed by ScyllaDB Manager rely on the same [backup specification](https://manager.docs.scylladb.com/branch-3.10/backup/specification.md),
...
| SSTable streaming directly from [gcs](https://manager.docs.scylladb.com/branch-3.10/backup/setup-gcs.md)                  |             2026.1 | Same as above.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | Same as above.                                                                                                                                                                                                              |

## Configuration

Native restore requires the same ScyllaDB and ScyllaDB Manager Agent configuration as native backup.
Follow the steps described in [Configuration](https://manager.docs.scylladb.com/branch-3.10/backup/native-backup.md#configure-native-backup-in-scylla) to configure each ScyllaDB node.
...
The native restore usage is controlled with the [sctool restore –method](https://manager.docs.scylladb.com/branch-3.10/sctool/restore.md#sctool-restore) flag.
...
Note that [sctool restore –rate-limit –transfers –unpin-agent-cpu](https://manager.docs.scylladb.com/branch-3.10/sctool/restore.md#sctool-restore) flags do not take effect when using native restore,
...
You can [create restore task](https://manager.docs.scylladb.com/branch-3.10/sctool/restore.md#sctool-restore) with the desired method:
