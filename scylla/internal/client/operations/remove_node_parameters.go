...
// WithHostID adds the hostID to the remove node params
func (o *RemoveNodeParams) WithHostID(hostID string) *RemoveNodeParams {
	o.SetHostID(hostID)
	return o
}

// SetHostID adds the hostId to the remove node params
func (o *RemoveNodeParams) SetHostID(hostID string) {
	o.HostID = hostID
}
