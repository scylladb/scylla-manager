...
// WithAddr adds the addr to the get version params
func (o *GetVersionParams) WithAddr(addr string) *GetVersionParams {
	o.SetAddr(addr)
	return o
}

// SetAddr adds the addr to the get version params
func (o *GetVersionParams) SetAddr(addr string) {
	o.Addr = addr
}
