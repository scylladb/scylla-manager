...
* (Optional) CQL connection - used for the ScyllaDB [Health Check](https://manager.docs.scylladb.com/master/health-check.md#scylla-health-check)

![image](images/architecture.jpg)

## Installation

To proceed with installation go to [Install ScyllaDB Manager](https://manager.docs.scylladb.com/master/install-scylla-manager.md).
