...
Retention lock supports the following modes controlled by the [sctool backup –retention-lock-mode](https://manager.docs.scylladb.com/master/sctool/backup.md#sctool-backup) flag:
