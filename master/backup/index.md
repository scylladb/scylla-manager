...
Using [sctool backup](https://manager.docs.scylladb.com/master/sctool/backup.md#sctool-backup) command, you can schedule a backup of a managed cluster.
...
For the purposes of backing up schema, ScyllaDB Manager requires CQL credentials ([sctool cluster update –username –password](https://manager.docs.scylladb.com/master/sctool/cluster.md#cluster-update)).
In case of an Alternator cluster, ScyllaDB Manager additionally requires Alternator credentials ([sctool cluster update –alternator-access-key-id –alternator-secret-access-key](https://manager.docs.scylladb.com/master/sctool/cluster.md#cluster-update)).
...
2. **Schema** - Upload the schema in CQL text format to the backup storage destination,
   ...
   If you didn’t you can [update the cluster using sctool](https://manager.docs.scylladb.com/master/sctool/cluster.md#cluster-update) at any point in time.

   These CQL files are necessary for schema restoration ([sctool restore –restore-schema](https://manager.docs.scylladb.com/master/sctool/restore.md#sctool-restore)).
...
* [Setup Amazon S3](https://manager.docs.scylladb.com/master/backup/setup-amazon-s3.md)
* [Setup S3 compatible storage](https://manager.docs.scylladb.com/master/backup/setup-s3-compatible-storage.md)
* [Setup Google Cloud Storage](https://manager.docs.scylladb.com/master/backup/setup-gcs.md)
* [Setup Azure Blob Storage](https://manager.docs.scylladb.com/master/backup/setup-azure-blobstorage.md)
* [Setup Local Storage](https://manager.docs.scylladb.com/master/backup/setup-local-storage.md)
...
Another option is to purge them manually. If you want to remove the snapshots manually, please refer to the [backup specification](https://manager.docs.scylladb.com/master/backup/specification.md)
...
[sctool backup delete local-snapshots](https://manager.docs.scylladb.com/master/sctool/backup.md#backup-delete-local-snapshots) command.
