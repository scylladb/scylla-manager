...
1. Make sure that ScyllaDB Manager Agent is [configured](https://manager.docs.scylladb.com/master/install-scylla-manager-agent.md#install-agent) as usual.
2. Configure [object_storage_endpoints](https://docs.scylladb.com/manual/stable/operating-scylla/admin.html#configuring-object-storage) in scylla.yaml.
   ...
   > in the same way as it is done for the regular backup purposes (see [Setup Amazon S3](https://manager.docs.scylladb.com/master/backup/setup-amazon-s3.md)). The configurations in scylla.yaml and scylla-manager-agent.yaml should match.
...
The native backup usage is controlled with the [sctool backup –method](https://manager.docs.scylladb.com/master/sctool/backup.md#sctool-backup) flag.
...
Note that [sctool backup –rate-limit –transfers](https://manager.docs.scylladb.com/master/sctool/backup.md#sctool-backup) flags do not take effect when using native backup,
...
You can [create a new backup task](https://manager.docs.scylladb.com/master/sctool/backup.md#sctool-backup) with the desired method:

```none
sctool backup -c <cluster ID> -L <backup locations> --method native
```

You can also [update existing backup task](https://manager.docs.scylladb.com/master/sctool/backup.md#backup-update) to use a different method:
