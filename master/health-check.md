...
the [sctool tasks](https://manager.docs.scylladb.com/master/sctool/task.md#task-list) command.
...
The results are available using the [sctool status](https://manager.docs.scylladb.com/master/sctool/status.md#id1) command.
...
* UNAUTHORISED - Missing or Incorrect [Authentication Token](https://manager.docs.scylladb.com/master/install-scylla-manager-agent.md#configure-auth-token) was used
* TIMEOUT - Timeout
...
You may specify CQL `username` and `password` flags when adding cluster to ScyllaDB Manager using [sctool cluster add](https://manager.docs.scylladb.com/master/sctool/cluster.md#cluster-add) command.
It’s also possible to add or change that using [sctool cluster update](https://manager.docs.scylladb.com/master/sctool/cluster.md#cluster-update) command.
...
Please check the ScyllaDB Manager [ScyllaDB Manager Config](https://manager.docs.scylladb.com/master/config/scylla-manager-config.md#configuration-file) to adjust timeouts for your cluster.
