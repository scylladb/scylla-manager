...
You cannot initiate a backup without a cluster. Make sure you add a cluster ([cluster add](https://manager.docs.scylladb.com/master/sctool/cluster.md#cluster-add)) before initiating a backup.
...
To see the validation results use [progress](https://manager.docs.scylladb.com/master/sctool/progress.md#task-progress) command.
