...
1. Get to know address and port ScyllaDB Manager Server is listening on.
   ...
   If that is not the case check the `http` and `https` configuration options in the [config file](https://manager.docs.scylladb.com/master/config/scylla-manager-config.md).
