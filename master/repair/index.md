...
It also supports [–keyspace-replication](https://manager.docs.scylladb.com/master/sctool/repair.md#sctool-repair) flag allowing to filter keyspaces by their replication type.

Apart from the regular repair task, there is a dedicated [tablet repair](https://manager.docs.scylladb.com/master/sctool/repair.md#repair-tablet) task optimized for tablet keyspaces.
...
Regular and tablet repair tasks can run in parallel only when regular repair task uses [–keyspace-replication=vnodes](https://manager.docs.scylladb.com/master/sctool/repair.md#sctool-repair).
...
By default ScyllaDB Manager runs repairs with full parallelism, you can change that using [sctool repair –parallel flag](https://manager.docs.scylladb.com/master/sctool/repair.md#sctool-repair).
...
The default intensity is one, you can change that using [sctool repair –intensity flag](https://manager.docs.scylladb.com/master/sctool/repair.md#sctool-repair).
...
* Schedule a repair with [sctool repair](https://manager.docs.scylladb.com/master/sctool/repair.md#sctool-repair)
* Update a repair specification with [sctool repair update](https://manager.docs.scylladb.com/master/sctool/repair.md#reschedule-a-repair)
* Update a running repair task with [sctool repair control](https://manager.docs.scylladb.com/master/sctool/repair.md#repair-control)

More on the topic of repair speed can be found in [Repair faster](https://manager.docs.scylladb.com/master/repair/repair-faster.md) and [Repair slower](https://manager.docs.scylladb.com/master/repair/repair-slower.md) articles.
