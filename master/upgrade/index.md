...
#### NOTE
See [Compatibility Matrix](https://manager.docs.scylladb.com/master/compatibility-matrix.md) for information about compatibility between ScyllaDB Manager and ScyllaDB versions.
...
#### NOTE
If you plan to use native backup after the upgrade, we recommend [configuring](https://manager.docs.scylladb.com/master/backup/native-backup.md#configure-native-backup-in-scylla) it at this point.
