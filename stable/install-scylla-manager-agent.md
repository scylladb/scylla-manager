...
* [Configure backup location](https://manager.docs.scylladb.com/stable/backup/index.md#backup-location)
* [Configure native backup](https://manager.docs.scylladb.com/stable/backup/native-backup.md#configure-native-backup-in-scylla)
* [Add a Cluster](https://manager.docs.scylladb.com/stable/add-a-cluster.md)
