...
| **2026.1.0**     | ![integration-tests-2026.1.0-IPV4-tablets-native-native]<br/>![integration-tests-2026.1.0-IPV6-nossl-rclone-rclone] | Restoration of **Authentication** and **Service Levels** is not supported<br/>Restoration of schema containing **Alternator** tables is not supported |
...
[integration-tests-2026.1.0-IPV4-tablets-native-native]: https://github.com/scylladb/scylla-manager/actions/workflows/integration-tests-2026.1.0-IPV4-tablets-native-native.yaml/badge.svg?branch=master
[integration-tests-2026.1.0-IPV6-nossl-rclone-rclone]: https://github.com/scylladb/scylla-manager/actions/workflows/integration-tests-2026.1.0-IPV6-nossl-rclone-rclone.yaml/badge.svg?branch=master
