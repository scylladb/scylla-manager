...
| **2025.1.7**     | ![integration-tests-2025.1.7-IPV4]<br/>![integration-tests-2025.1.7-IPV6-tablets-nossl]               | Restoration of **Authentication** and **Service Levels** is not supported<br/>Restoration of schema containing **Alternator** tables is not supported |
| **2025.2.2**     | ![integration-tests-2025.2.2-IPV4-tablets-native]<br/>![integration-tests-2025.2.2-IPV6-nossl-rclone] | Restoration of **Authentication** and **Service Levels** is not supported<br/>Restoration of schema containing **Alternator** tables is not supported |
| **2025.3.1**     | ![integration-tests-2025.3.1-IPV4-tablets-rclone]<br/>![integration-tests-2025.3.1-IPV6-nossl-rclone] | Restoration of **Authentication** and **Service Levels** is not supported<br/>Restoration of schema containing **Alternator** tables is not supported |
...
[integration-tests-2024.1.20-IPV4]: https://github.com/scylladb/scylla-manager/actions/workflows/integration-tests-2024.1.20-IPV4.yaml/badge.svg?branch=branch-3.6
[integration-tests-2024.1.20-IPV6-raftschema-nossl]: https://github.com/scylladb/scylla-manager/actions/workflows/integration-tests-2024.1.20-IPV6-raftschema-nossl.yaml/badge.svg?branch=branch-3.6
[integration-tests-2025.1.7-IPV4]: https://github.com/scylladb/scylla-manager/actions/workflows/integration-tests-2025.1.7-IPV4.yaml/badge.svg?branch=branch-3.6
[integration-tests-2025.1.7-IPV6-tablets-nossl]: https://github.com/scylladb/scylla-manager/actions/workflows/integration-tests-2025.1.7-IPV6-tablets-nossl.yaml/badge.svg?branch=branch-3.6
[integration-tests-2025.2.2-IPV4-tablets-native]: https://github.com/scylladb/scylla-manager/actions/workflows/integration-tests-2025.2.2-IPV4-tablets-native.yaml/badge.svg?branch=branch-3.6
[integration-tests-2025.2.2-IPV6-nossl-rclone]: https://github.com/scylladb/scylla-manager/actions/workflows/integration-tests-2025.2.2-IPV6-nossl-rclone.yaml/badge.svg?branch=branch-3.6
[integration-tests-2025.3.1-IPV4-tablets-rclone]: https://github.com/scylladb/scylla-manager/actions/workflows/integration-tests-2025.3.1-IPV4-tablets-rclone.yaml/badge.svg?branch=branch-3.6
[integration-tests-2025.3.1-IPV6-nossl-rclone]: https://github.com/scylladb/scylla-manager/actions/workflows/integration-tests-2025.3.1-IPV6-nossl-rclone.yaml/badge.svg?branch=branch-3.6
[integration-tests-latest-IPV4-native]: https://github.com/scylladb/scylla-manager/actions/workflows/integration-tests-latest-IPV4-native.yaml/badge.svg?branch=branch-3.6
[integration-tests-latest-IPV6-tablets-nossl-rclone]: https://github.com/scylladb/scylla-manager/actions/workflows/integration-tests-latest-IPV6-tablets-nossl-rclone.yaml/badge.svg?branch=branch-3.6
