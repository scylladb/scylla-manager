...
| **2025.3.1**     | ![integration-tests-2025.3.1-IPV4-tablets-rclone-native]<br/>![integration-tests-2025.3.1-IPV6-nossl-rclone-rclone] | Restoration of **Authentication** and **Service Levels** is not supported<br/>Restoration of schema containing **Alternator** tables is not supported |
...
[integration-tests-2025.1.7-IPV4]: https://github.com/scylladb/scylla-manager/actions/workflows/integration-tests-2025.1.7-IPV4.yaml/badge.svg?branch=master
[integration-tests-2025.1.7-IPV6-tablets-nossl]: https://github.com/scylladb/scylla-manager/actions/workflows/integration-tests-2025.1.7-IPV6-tablets-nossl.yaml/badge.svg?branch=master
...
[integration-tests-2025.3.1-IPV4-tablets-rclone-native]: https://github.com/scylladb/scylla-manager/actions/workflows/integration-tests-2025.3.1-IPV4-tablets-rclone-native.yaml/badge.svg?branch=master
[integration-tests-2025.3.1-IPV6-nossl-rclone-rclone]: https://github.com/scylladb/scylla-manager/actions/workflows/integration-tests-2025.3.1-IPV6-nossl-rclone-rclone.yaml/badge.svg?branch=master
