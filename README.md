...
| **2025.1.11**    | ![integration-tests-2025.1.11-IPV4]<br/>![integration-tests-2025.1.11-IPV6-tablets-nossl]                                                | Restoration of **Authentication** and **Service Levels** is not supported<br/>Restoration of schema containing **Alternator** tables is not supported |
| **2025.3.7**     | ![integration-tests-2025.3.7-IPV4-tablets-rclone-native]<br/>![integration-tests-2025.3.7-IPV6-nossl-rclone-rclone]                      | Restoration of **Authentication** and **Service Levels** is not supported<br/>Restoration of schema containing **Alternator** tables is not supported |
| **2025.4.3**     | ![integration-tests-2025.4.3-IPV4-native-rclone]<br/>![integration-tests-2025.4.3-IPV6-tablets-nossl-rclone-rclone]                      | Restoration of **Authentication** and **Service Levels** is not supported<br/>Restoration of schema containing **Alternator** tables is not supported |
| **2026.1.0-rc2** | ![integration-tests-2026.1.0-rc2-IPV4-tablets-native-native]<br/>![integration-tests-2026.1.0-rc2-IPV6-nossl-rclone-rclone-localstorage] | Restoration of **Authentication** and **Service Levels** is not supported<br/>Restoration of schema containing **Alternator** tables is not supported |
...
[integration-tests-2026.1.0-rc2-IPV6-nossl-rclone-rclone-localstorage]: https://github.com/scylladb/scylla-manager/actions/workflows/integration-tests-2026.1.0-rc2-IPV6-nossl-rclone-rclone-localstorage.yaml/badge.svg?branch=master
