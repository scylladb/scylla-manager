...
| **2026.1.1**     | ![integration-tests-2026.1.1-IPV4-tablets-native-native]<br/>![integration-tests-2026.1.1-IPV6-nossl-rclone-rclone-localstorage] | Restoration of **Authentication** and **Service Levels** is not supported |
...
[integration-tests-2026.1.1-IPV4-tablets-native-native]: https://github.com/scylladb/scylla-manager/actions/workflows/integration-tests-2026.1.1-IPV4-tablets-native-native.yaml/badge.svg?branch=master
[integration-tests-2026.1.1-IPV6-nossl-rclone-rclone-localstorage]: https://github.com/scylladb/scylla-manager/actions/workflows/integration-tests-2026.1.1-IPV6-nossl-rclone-rclone-localstorage.yaml/badge.svg?branch=master
