...
//go:generate mockgen -destination mock_policy_test.go -mock_names Policy=mockPolicy -package scheduler github.com/scylladb/mermaid/service/scheduler Policy
//go:generate mockgen -destination mock_runner_test.go -mock_names Runner=mockRunner -package scheduler github.com/scylladb/mermaid/service/scheduler Runner
