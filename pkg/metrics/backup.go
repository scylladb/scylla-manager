...
func NewBackupMetrics() BackupMetrics {
	...
	return BackupMetrics{
		...
		Restore: RestoreM{
			...
			filesDownloadedBytes: gr("Number of bytes downloaded from backup location.",
				"files_downloaded_bytes", "cluster", "manifest", "keyspace", "table"),
			filesSkippedBytes: gr("Number of deduplicated bytes already downloaded from backup location.",
				"files_skipped_bytes", "cluster", "manifest", "keyspace", "table"),
			filesFailedBytes: gr("Number of bytes failed to download from backup location.",
