...
func New(l backupmanifest.Location, dataDir string, logger log.Logger, opts ...Option) (*Downloader, error) {
...
func (d *Downloader) DryRun(ctx context.Context, m backupmanifest.ManifestInfoWithContent) (Plan, error) {
	d.dryRun = true
	d.plan = Plan{m: m}
...
func (d *Downloader) Download(ctx context.Context, m backupmanifest.ManifestInfoWithContent) error {
	d.dryRun = false
	return d.download(ctx, m, parallel.NoLimit)
}

func (d *Downloader) download(ctx context.Context, m backupmanifest.ManifestInfoWithContent, workers int) error {
...
func (d *Downloader) filteredIndex(ctx context.Context, m backupmanifest.ManifestInfoWithContent) ([]backupmanifest.FilesMeta, error) {
	var i []backupmanifest.FilesMeta
	...
	var index []backupmanifest.FilesMeta
	for _, u := range i {
...
func (d *Downloader) clearTableIfNeeded(ctx context.Context, u backupmanifest.FilesMeta) error {
	if !d.clearTables {
		return nil
	}
...
func (d *Downloader) downloadFiles(ctx context.Context, m backupmanifest.ManifestInfoWithContent, u backupmanifest.FilesMeta) error {
...
func (d *Downloader) dstDir(u backupmanifest.FilesMeta) (dir string) {
	switch d.mode {
	case DefaultTableDirMode:
