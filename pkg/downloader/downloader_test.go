...
func dummyManifest() backupmanifest.ManifestInfoWithContent {
	return backupmanifest.ManifestInfoWithContent{
		ManifestInfo: &backupmanifest.ManifestInfo{},
		ManifestContentWithIndex: &backupmanifest.ManifestContentWithIndex{
			Index: []backupmanifest.FilesMeta{
				{
					Keyspace: "foo",
					Table:    "bar",
				},
