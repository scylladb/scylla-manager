...
type Workload struct {
	TotalSize    int64
	LocationSize map[backupmanifest.Location]int64
...
func (w *tablesWorker) IndexWorkload(ctx context.Context, locations []backupmanifest.Location) (Workload, error) {
...
func (w *tablesWorker) indexLocationWorkload(ctx context.Context, location backupmanifest.Location) ([]RemoteDirWorkload, error) {
...
func (w *tablesWorker) createRemoteDirWorkloads(ctx context.Context, location backupmanifest.Location) ([]RemoteDirWorkload, error) {
	var rawWorkload []RemoteDirWorkload
	err := w.forEachManifest(ctx, location, func(m backupmanifest.ManifestInfoWithContent) error {
		return m.ForEachIndexIterWithError(nil, func(fm backupmanifest.FilesMeta) error {
...
func aggregateWorkload(rawWorkload []RemoteDirWorkload) Workload {
	var (
		totalSize    int64
		locationSize = make(map[backupmanifest.Location]int64)
...
func filesMetaToSSTables(fm backupmanifest.FilesMeta) (map[string]SSTable, error) {
