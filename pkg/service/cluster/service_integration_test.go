		...
		expected := []cluster.Node{
			{
				...
				ShardNum:          2,
				PrometheusAddress: ToCanonicalIP(IPFromTestNet("11")),
				PrometheusPort:    9180,
			},
			{
				Datacenter:        "dc1",
				...
				ShardNum:          2,
				PrometheusAddress: ToCanonicalIP(IPFromTestNet("12")),
				PrometheusPort:    9180,
			},
			{
				Datacenter:        "dc1",
				...
				ShardNum:          2,
				PrometheusAddress: ToCanonicalIP(IPFromTestNet("13")),
				PrometheusPort:    9180,
			},
			{
				Datacenter:        "dc2",
				...
				ShardNum:          2,
				PrometheusAddress: ToCanonicalIP(IPFromTestNet("21")),
				PrometheusPort:    9180,
			},
			{
				Datacenter:        "dc2",
				...
				ShardNum:          2,
				PrometheusAddress: ToCanonicalIP(IPFromTestNet("22")),
				PrometheusPort:    9180,
			},
			{
				Datacenter:        "dc2",
				...
				ShardNum:          2,
				PrometheusAddress: ToCanonicalIP(IPFromTestNet("23")),
				PrometheusPort:    9180,
			},
		}
