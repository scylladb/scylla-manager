...
func (s *Service) GetDescribeSchema(ctx context.Context, clusterID uuid.UUID, snapshotTag string, location backupspec.Location, filter DescribeSchemaFilter,
	...
	schemaFilePath, err := getSchemaFilePath(ctx, client, host, location, snapshotTag, filter)
	if err != nil {
...
func getSchemaFilePath(ctx context.Context, client *scyllaclient.Client, host string, loc backupspec.Location, tag string, f DescribeSchemaFilter) (string, error) {
