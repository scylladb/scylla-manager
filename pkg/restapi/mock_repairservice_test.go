...
// SetSingleHostParallelism mocks base method.
func (m *MockRepairService) SetSingleHostParallelism(arg0 context.Context, arg1 uuid.UUID, arg2 int) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetSingleHostParallelism", arg0, arg1, arg2)
	ret0, _ := ret[0].(error)
	return ret0
}

// SetSingleHostParallelism indicates an expected call of SetSingleHostParallelism.
func (mr *MockRepairServiceMockRecorder) SetSingleHostParallelism(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetSingleHostParallelism", reflect.TypeOf((*MockRepairService)(nil).SetSingleHostParallelism), arg0, arg1, arg2)
}
